...
/**
 * Clase principal (Main) que orquesta el lanzamiento de múltiples hilos
 * procesadores. Utiliza CountDownLatch para esperar a que finalicen todos los
 * hilos antes de calcular y mostrar el tiempo promedio de ejecución.
 */
public class Main {

    /**
     * Punto de entrada principal para el programa de sincronización por
     * barrera.
     *
     * @param args Argumentos de consola (no se utilizan).
     * @throws InterruptedException Si ocurre una interrupción mientras se
